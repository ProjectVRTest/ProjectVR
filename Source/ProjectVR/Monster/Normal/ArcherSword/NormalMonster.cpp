...
ANormalMonster::ANormalMonster()
{
	...
	static ConstructorHelpers::FObjectFinder<UAnimMontage>NMAttackReverse_Montage(TEXT("AnimMontage'/Game/Blueprints/Monster/Normal/ArcherSword/Animation/NM_Attack_Reverse.NM_Attack_Reverse'"));
	...
	static ConstructorHelpers::FObjectFinder<UBehaviorTree>NormalSwordMonster_BT(TEXT("BehaviorTree'/Game/Blueprints/Monster/Normal/ArcherSword/AI/BT_NormalSwordMonster.BT_NormalSwordMonster'"));
	...
	static ConstructorHelpers::FObjectFinder<UBehaviorTree>NormalMoveArcherMonster_BT(TEXT("BehaviorTree'/Game/Blueprints/Monster/Normal/ArcherSword/AI/BT_NormalMoveArcherMonster.BT_NormalMoveArcherMonster'"));
	...
	static ConstructorHelpers::FObjectFinder<UBehaviorTree>NormalDontMoveArcherMonster_BT(TEXT("BehaviorTree'/Game/Blueprints/Monster/Normal/ArcherSword/AI/BT_NormalDontMoveArcherMonster.BT_NormalDontMoveArcherMonster'"));
	...
	static ConstructorHelpers::FObjectFinder<UClass>ABP_NormalMonster(TEXT("AnimBlueprint'/Game/Blueprints/Monster/Normal/ArcherSword/Blueprints/ABP_NormalMonster.ABP_NormalMonster_C'"));
...
float ANormalMonster::TakeDamage(float Damage, FDamageEvent const & DamageEvent, AController * EventInstigator, AActor * DamageCauser)
{
	...
	GLog->Log(FString::Printf(TEXT("Damage : %f"), Damage));
	GLog->Log(FString::Printf(TEXT("NM HP : %f"), CurrentHP));
