...
ANMWeaponBow::ANMWeaponBow()
{
	...
	static ConstructorHelpers::FObjectFinder<UClass>ABP_Bow(TEXT("AnimBlueprint'/Game/Blueprints/Monster/Normal/ArcherSword/Blueprints/Weapon/Bow/ABP_Bow.ABP_Bow_C'"));
